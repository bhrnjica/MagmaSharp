...
void mv2dgesvds_cpu_test()
{
	...
	/* Compute SVD */
	info = mbv2dgesvds_cpu(false, m, n, a, s, u, true, vt, true);
...
void mv2sgesvds_test()
{
	...
	/* Compute SVD */
	info = mbv2sgesvds(false,m, n, a, s, u,true, vt, true);
...
void mv2sgesvd_test()
{
	...
	/* Compute SVD */
	info = mbv2sgesvd(false,jobU, jobV, m, n, a, lda, s, u, ldu, vt, ldvt);
